...
- forceVerify : `mods/important.jar` Cette option permet de forcer la vérification d'un fichier ou d'un dossier même s'il est couvert par `ignored`. `forceVerify` est prioritaire sur `ignored`.
